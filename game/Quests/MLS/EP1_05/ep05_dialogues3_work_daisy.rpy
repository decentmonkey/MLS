...
#call ep05_dialogues3_work_daisy_1() # мысли в воскресенье утром, когда Барди еще дома и собирается выйти в город
#call ep05_dialogues3_work_daisy_2() # дом Дейзи, разговор с ней перед работой курьером
#call ep05_dialogues3_work_daisy_3() # сцена с клиенткой магазина Дейзи
#call ep05_dialogues3_work_daisy_4() # сцена с клиенткой магазина Дейзи, если Барди в первый раз отказался
...
label ep05_dialogues3_work_daisy_1:
    ...
    if ep05_dialogues2_family_daisy_visit_day > 0:
        menu:
        ...
        bardi_t "Дейзи сказала, что дела ее магазина пошли в гору."
        bardi_t "Такими темпами, я скоро смогу неплохо зарабатывать, помогая ей..."
...
label ep05_dialogues3_work_daisy_3:
    ...
    # Кэрри с ухмылкой.
    imgd 902581
    client_carrie "Да-да... Так я тебе и поверила."
    imgd 902580
    ...
    menu:
        ...
        "Конечно есть!": # + Rat
            ...
            bardi_t "Правда, потом у меня будет полный завал..."
            ...
            sound2 wow
            w
            bardi_t "Воу! И зачем такой красотке, как она, игрушки из интим-магазина?.. Неужели, она одинока?"
            bardi_t "Хотя, конечно нет! У нее должно быть целая толпа поклонников..."
            # Кэрри ушла на кухню.
            fadeblack 1.0
            imgf 911991
            sound2 snd_plates
            ...
            bardi_t "Может быть, она одна из тех, кто писал комментарии про меня на сайте магазина?.."
            imgd 911992
            bardi_t "Хмм... Интересно, что же будет дальше?.."
            bardi_t "Кстати, а что она вообще заказала?"
            ...
            imgf 911994
            show screen image_shake("/images/Slides/img_911994.jpg")
            sound2 wow
            w
            bardi_t "Вау!"
            imgd 911995
            ...
            imgd 912012
            bardi_t "Так! Что это за чувство такое странное?.. И знакомое..."
            ...
            imgd 912014
            bardi_t "Хотя бы то, что после него у меня..."
            ...
            img 912011
            bardi_t "Странный кофе! Секс-игрушки! Помощь, чтобы разобраться с ними!"
            bardi_t "Та вигра уже в продаже в магазине Дейзи?!"
            bardi_t "Вот я идиот!"
            ...
            imgd 912011
            bardi_t "Ох, Кэрри!.. Теперь твои намерения мне более чем ясны..."
            bardi_t "Черт! И куда я сейчас пойду с таким стояком?!"
            bardi_t "Тем более, не отказывать же мне клиентке Дейзи в помощи с товаром, верно?.."
            bardi "..."
            bardi "Где игрушка?"
            ...
            imgd 912017
            bardi_t "Он что, уже вставлен в нужное место?.."
            menu:
            ...
            bardi "И почему нельзя было просто сказать изначально о том, чего ты хочешь на самом деле?"
            ...
            bardi "Я догадался насчет виагры. Ты ведь это в мой кофе подсыпала?"
            img 902825
            sound fear2
            client_carrie "Что?!"
            ...
            imgd 902829
            bardi "А почему ты сразу не сказала, с какой целью зовешь меня к себе в дом?"
            imgd 902830
            ...
            client_carrie "Значит, я не первая у тебя такая отчаянная клиентка?.."
            imgd 902829
            ...
            music Postcard_From_Hell
            imgf 902844
            bardi_t "И я могу лишиться этой работы, если я продолжу так терять время!"
...
label ep05_dialogues3_work_daisy_4b:
    sound snd_door_locked1
    pause 1.0
    bardi_t "Закрыто."
    bardi_t "Кажется, лучше зайти сюда [днем]..."
    return
...
label ep05_dialogues3_work_daisy_4:
    ...
    sound2 step_stairs_short
    imgfl 902568
    bardi_t "Так, опять этот адрес... В третий раз уже?"
    ...
    imgfl 902572
    sound2 wow
    bardi_t "Вау! Какая же она все-таки красотка!.."
    imgf 902574
