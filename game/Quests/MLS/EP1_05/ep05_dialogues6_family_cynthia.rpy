...
label ep05_dialogues6_family_cynthia_1:
    ...
    bardi_t "Оливия ненавидит абсолютно все и вся! Но только не тебя, Синтия!"
    ...
    bardi_t "Мдаа... Примерно этого я и ожидал..."
    imgd 902622
    bardi_t "Первая - стерва, которой ее гордость не позволит прийти и на прямую разобраться..."
    ...
    imgd 902627
    bardi_t "Как стерва она себя ведет..."
    imgd 902628
    ...
    bardi "?!"
    imgd 902639
    bardi_t "Подарок?! А нужен ли он вообще, Синтия?"
    bardi_t "Оливия спит и видит, как бы извиниться перед тобой!"
    bardi_t "Хотя..."
    bardi_t "Если это поможет им быстрее помириться..."
    ...
    bardi_t "А не слишком ли это дорогой подарок для психованной Оливии?!"
    ...
    bardi_t "Не знаю, на кого она намекает, но, надеюсь, ей не откажут..."
    ...
    imgd 902664
    bardi_t "Черт! Хватит ерзать у моего члена! У меня уже вставать начинает!"
    ...
    bardi_t "Черт! Ну вот почему именно я должен оплачивать подарок для Оливии?!"
    bardi_t "?!?!"
    # Меняйте ракурс.
    imgf 902671
    ...
    imgfl 902679
    bardi_t "Какого черта меня вообще в это втянули?! Все из-за этой Оливии!.."
    bardi_t "Ладно, разберусь по ходу. Для начала стоит поговорить с ней..."
