...
label ep03_dialogues1_family_morning_5:
    ...
    bardi_t "Я нашел подработку. А значит, я наконец-то, смогу начать копить деньги..."
    bardi_t "Нужно будет сходить в этот прокат великов."
    bardi_t "Возможно, уже сегодня я смогу что-то заработать."
    bardi_t "А потом загляну к Дейзи... Чтобы осбудить условия работы у нее."
