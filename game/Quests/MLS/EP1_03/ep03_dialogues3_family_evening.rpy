...
label ep03_dialogues3_family_evening_5:
    # вечером следующего дня, до вечеринки, у Барди открывается возможность пойти в гости к тете
    # тетя дома одна, муж в одной из многочисленных командировок, дочь гуляет с подругами
    # тетя сообщает Барди, что в интернет-магазине продает интимные игрушки
    # Барди удивленно спрашивает, почему именно этот вид товара
    # тетя хихикает и говорит, что ей нравится этот бизнес
    # она предлагает Барди, чтобы он помогал ей в качестве курьера
    # но платить за каждый заказ она пока не сможет, пять заказов - 2 бакса
    # Барди в афиге от такой наглости
    # может сразу согласиться или берет время подумать
    # тетя весь разговор игриво на него смотрит и ведет себя сексуально
    # всячески показывает вид, что она была бы не против его ахнуть
    # на прощание она целует его и многозначительно приглашает забежать к ней в гости как-нибудь вечерком
    return



    # после визита к тете звонит Шон и гвоорит, ты где чувак? все уже собрались и успели напиться
    # Барди идет на вечеринку
