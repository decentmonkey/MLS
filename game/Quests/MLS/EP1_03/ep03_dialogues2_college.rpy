...
label ep03_dialogues2_college_18:
    ...
    # в этот момент раздается звонок телефона, Сара выходит из состояния задумчивости и быстро берет в руки свой телефон
    # отвечает на звонок
    student_sarah "Да? Хорошо, через минуту выйду."
    # отключает телефон и смотрит на Барди
    student_sarah "Мне пора. Такси приехало."
    bardi "Такси? Когда ты успела вызвать такси?"
    student_sarah "До того, как ты ко мне подошел."
    # она встает и покачиваясь идет к двери
    # ее заносит и она чуть ли не падает
    student_sarah "Ой! Черт!"
    student_sarah "Как же кружится голова!.."
    student_sarah "Кажется, я сама не дойду..."
    # поворачивается и смотрит на Барди
    bardi "Нормально так тебя повело. Вроде выпила не так много..."
    student_sarah "Угу. Вообще-то, я никогда не пила этой гадости раньше..."
