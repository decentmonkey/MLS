...
label ep03_dialogues4_bike_rental_2:
    ...
    # Райт мнется
    mr_wright "Нуу... Для начала я мог бы платить тебе один доллар за выход на работу."
    bardi "Доллар в день?!"
    ...
    mr_wright "Но знаешь что? Если ты сможешь подтянуть клинетов, то мы сможем обсудить твое повышение!"
    ...
    mr_wright "Сейчас у меня нет времени, но завтра ты можешь прийти в прокат и посмотреть, что к чему."
    mr_wright "Возможно, ты найдешь эту работу интересной..."
    bardi_t "Сомневаюсь..."
    bardi_t "Один бакс в день - это очень мало."
    mr_wright "Не торопись давать ответ прямо сейчас. Подумай."
    mr_wright "Приходи завтра днем сюда и я тебе все покажу, [mcname]."
    bardi "Окей. Договорились, мистер Райт."
    mr_wright "До встречи."
    bardi "До свиданья, мистер Райт."
    # Райт уходит, Барди остается один
    bardi_t "Вот дерьмо!"
    bardi_t "Нахрена мне работа практически за бесплатно?!"
    bardi_t "Пустая трата времени!"
...
label ep03_dialogues4_bike_rental_3:
    ...
    bardi_t "Если Брукс станет постоянной клиенткой проката, то я согласен на эту работу даже за бакс..."
    ...
    menu:
        "Согласиться.":
            $ mlsBardiDay4BikeRental2 = day # Барди согласился работать в велопрокате
            ...
            bardi_t "Если я хочу быстрее свалить из этой дыры, то надо работать."
            # Райт обрадованно
            mr_wright "Вот и отлично!"
            mr_wright "Рад, что ты согласился!"
            mr_wright "Приходи сюда завтра после колледжа."
            mr_wright "Я тебе все объясню и покажу."
            pass
        "Не торопиться.":
            bardi_t "Сначала я поговорю с Дейзи насчет работы у нее..."
            bardi_t "А потом приму решение."
            bardi_t "Возможно, она предложит мне больший заработок, чем Райт."
            bardi_t "Тем более, я очень сомневаюсь, что этот велопрокат можно оживить..."
            bardi_t "Если я хочу быстрее свалить из этой дыры, то нужно зарабатывать больше, чем бакс в день."
            bardi "Я подумаю, мистер Райт..."
            mr_wright "Хорошо, [mcname]."
            mr_wright "Если надумаешь, приходи сюда после колледжа."
            mr_wright "Я тебе все объясню."
            mr_wright "Надеюсь, что ты согласишься помогать мне."
            bardi "Я не обещаю, но если передумаю - приду."
            pass
    mr_wright "Договорились, [mcname]."
    mr_wright "Хорошего тебе дня!"
    bardi "До свиданья, мистер Райт."
    # Райт отходит к великам у трейлера
    bardi_t "Да уж... Я рассчитывал на что-то большее..."
