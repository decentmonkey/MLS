...
#    sound2 wow
    ...
    imgd 901704
    cynthia "Ну и что?"
    cynthia "Моя мама и твой отец хорошие друзья. Мы сейчас живем в одном доме. Ты мне почти как брат, а я почти что твоя сестра."
    imgd 901703
...
#    sound2 fear2
    ...
    imgd 901707
    cynthia "Разве это не правильно, что в такой ситуации я пытаюсь воспринимать тебя как брата? Просто мне кажется, что по другому быть и не должно..."
    music Step_By_Step
    imgd 901708
    ...
    bardi "Все окей, Синтия. Ты, в принципе, права. Мы все живем под одной крышей."
    ...
    cynthia "А я ей говорю, что ты нам почти что брат и не надо так говорить о тебе..."
    imgd 901711
    ...
    imgd 901698
    cynthia "Я этого не понимаю! Ты же такой добрый, такой хороший!.."
...
#    sound fear2
    ...
    cynthia "Мы живем под одной крышей! Он нам как брат! А я не собираюсь стесняться кого-то в этом доме!"
...
#    imgd 911267
    ...
    imgf 911271
    sound2 wow
    bardi_t "Вау!.. Какая же охренительная у тебя попка для такой милой и робкой девочки!.."
    imgd 911272
    ...
    bardi_t "Может, в итоге нам и удастся достаточно сблизиться?.."
...
#    bardi "!!!"
    ...
    cynthia "[mcname], ты уверен, что этот костюм мне идет?"
    ...
    show screen dream()
    with diss
    cynthia "Тебе понравилось, [mcname]?"
    img 911319
    show screen dream()
    with diss
