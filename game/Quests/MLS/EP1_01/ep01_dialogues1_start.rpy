...
label ep01_dialogues1_start_1b1:
    ...
    bardi "Начинай!"
    # она пьяно хихикает
    girl3 "[mcname] не терпится увидеть меня без одежды?"
    bardi "Мне не терпится увидеть тебя под собой. И не затягивай с этим."
    bardi "Ты же знаешь, что на твоем месте хотела бы оказаться любая малышка с той вечеринки?"
    girl3 "Знаю, хи-хи..."
    ...
    # он резко переворачивает ее на спину, высоко задирает ее ноги, сложив ее пополам (или ставит на четвереньки, держа за волосы)
    # и начинает вколачиваться в нее
    # она кайфует
    girl3 "Да! О, да!"
