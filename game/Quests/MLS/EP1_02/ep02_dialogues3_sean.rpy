...
label ep02_dialogues3_sean_3:
    ...
    bardi_t "..."
    ###! кто это такая? это та тетка с фото, которую он показывал? и что она здесь делает? она что, приняла меня за Шона? бла-бла-бла
    ###! мне притвориться что это он?
    ###! будет еще хуже, если она поймет что это кто-то другой. тогда я подставлю Шона :)
    ...
    ####! проверка на начальную сцену. если не было секса, то нет фразы за пару дней
...
#        "Написать Бекки.":
    ...
    bardi "Как насчет вирта или фотки без одежды?"
