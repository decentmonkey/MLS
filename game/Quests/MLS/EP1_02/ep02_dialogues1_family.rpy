...
default mlsBardiDay3SophieMoney2 = 0 # Барди отказался брать деньги у Софи (кролик)
...
label ep02_dialogues1_family_2:
    ...
    menu:
        "Взять деньги. Мне они нужнее.":
            ...
            bardi "Я обязательно тебе отдам деньги, когда заработаю."
            ...
            pass
        "Не брать. Она сама нуждается в этих деньгах.":
            bardi_t "Я не могу взять у нее эти деньги. Она сама в них нуждается."
            # Барди отводит руку Софи и не берет деньги
            bardi "Софи, я тут подумал..." ##->#####inc
            #####inc bardi "Мам, я тут подумал..."
            bardi "Если у Генри получится договориться о моей подработке..."
            bardi "То эти пять долларов не так уж мне и необходимы сейчас."
            bardi "Я сам заработаю."
            bardi "Но спасибо, что не забыла о нашем разговоре."
            sophie "Хорошо, [mcname]." ##->#####inc
            #####inc mother "Хорошо, сынок."
            sophie "Но если вдруг тебе понадобятся эти деньги..."
            bardi "Нет-нет. Купи себе что-нибудь."
            bardi "А я сам заработаю денег для себя."
            # Софи умиляется
            sophie "[mcname], как же ты повзрослел..." ##->#####inc
            #####inc mother "Сынок, как же ты повзрослел..."
            # балл RR -5
            $ mlsBardiDay3SophieMoney2 = day # Барди отказался брать деньги у Софи (кролик)
            pass
        "Подумать.":
            bardi_t "Фак... Я не знаю, что делать..."
            bardi "Софи, давай не сегодня." ##->#####inc
            #####inc bardi "Мам, давай не сегодня."
            bardi "Я попрошу у тебя денег, когда они мне будут нужны."
            bardi "Оставь эти деньги пока у себя."
            # она понимающе улыбается
            sophie "Хорошо, [mcname]." ##->#####inc
            #####inc mother "Хорошо, сынок."
            pass
