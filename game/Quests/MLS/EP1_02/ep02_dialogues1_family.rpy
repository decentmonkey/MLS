...
label ep02_dialogues1_family_1:
    ...
    imgd 900455
    sophie "Это... В общем, это нормально."
...
label ep02_dialogues1_family_2:
    ...
    menu:
        "Мне эти деньги нужнее.": # (+Rat)
            call rrmeter(-5, "ep02_dialogues1_family_2") from _rcall_rrmeter_2
            imgd 900467
            ...
            pass
        "Взять в долг.": # (+Rabbit)
            call rrmeter(5, "ep02_dialogues1_family_2") from _rcall_rrmeter_3
            imgd 900467
