...
label questHelp_init:
    ...
    $ questHelpDataQuests = {
        ...
        "house_10" : [t_("ДОМ"), t_("Идти на кухню."), t_("")],
        "house_11" : [t_("ДОМ"), t_("Возвратиться домой."), t_("")],
        "house_12" : [t_("ДОМ"), t_("Идти в свою комнату."), t_("")],
        "house_13" : [t_("ДОМ"), t_("Проверить инстаграм Эмили."), t_("")],
        "house_14" : [t_("ДОМ"), t_("Посмотреть кино с Синтией."), t_("")],
        "house_15" : [t_("ДОМ"), t_("Откровения Оливии."), t_("")],
        "house_16" : [t_("ДОМ"), t_("Лечь спать."), t_("")],
        ...
        # house_desc3
        "college_14" : [t_("КОЛЛЕДЖ"), t_("Идти в колледж."), t_("")],
        "college_15" : [t_("КОЛЛЕДЖ"), t_("Позвонить Шону."), t_("")],
        ...
        "college_18" : [t_("КОЛЛЕДЖ"), t_("Разглядеть Мисс Янг."), t_("")],
        ...
        "college_24" : [t_("КОЛЛЕДЖ"), t_("Рассмотреть Мисс Уилсон."), t_("")],
        ...
        "sean_3" : [t_("ШОН"), t_("Как Шон умудряется встречаться с Бекки без денег?"), t_("")]
