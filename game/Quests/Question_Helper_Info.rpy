...
#        "college_27" : [t_("КОЛЛЕДЖ"), t_("Погулять по колледжу."), t_("На сегодня все. Я могу покинуть колледж, либо погулять по нему.")],
    ...
    $ questHelpDataCategoriesDescriptions = [
        ...
        ["house_desc12", t_("ДОМ"), t_("И как меня только угораздило ввязаться в эти сестринские разборки?")],
        ...
        ["college_desc15", t_("КОЛЛЕДЖ"), t_("Если Сара всерьез не возьмется за тренировки, то продолжать смысла нет. Видимо, вопрос физры придется решать иначе... Только как?")],
        ...
        ["work_desc5", t_("РАБОТА"), t_("Хмм... Я даже не мог предположить, что у Дейзи такие горячие клиентки...")]
    ]
    return
