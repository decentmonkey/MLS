...
label questHelp_init:
    ...
    $ questHelpDataQuests = {
        ...
        "college_9" : [t_("КОЛЛЕДЖ"), t_("Флешбек из школьных лет."), t_("После окончания английского поговорить с миссис Адамс и выйти из кабинета. Послать Гарри.")],
        # срабатывание: Школьные времена давно прошли, если ты не заметил!
        # открываем college_11
        # при отказе - стоп для college_11
        "college_10" : [t_("КОЛЛЕДЖ"), t_("Флешбек из школьных лет."), t_("После окончания английского поговорить с миссис Адамс и выйти из кабинета. Толкнуть Гарри.")],
