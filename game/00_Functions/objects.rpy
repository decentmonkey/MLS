...
#                    return True
    ...
    def set_object_follow(obj_name, **kwargs):
        global obj_follow_list
        obj_follow_list[kwargs["scene"] + "_!_" + obj_name] = True
        return

    def clear_object_follow(obj_name, **kwargs):
        global obj_follow_list
        if obj_follow_list.has_key(kwargs["scene"] + "_!_" + obj_name):
            del(obj_follow_list[kwargs["scene"] + "_!_" + obj_name])
        return
