...
label housefriend_street_init:
    ...
    $ add_object_to_scene("Teleport_Map", {"type":3, "text" : t_("ГОРОД"), "larrow" : "arrow_down_2", "base":"Screen_Down_Arrow", "click" : "housefriend_street_environment", "xpos" : 960, "ypos" : 956, "zorder":11, "teleport":True, "group":"teleports"}, scene="housefriend_street")
...
label housefriend_street_environment:
    ...
    if obj_name == "Teleport_LivingRoom":
        call change_scene("house_livingroom")
        return
    return
