...
label college_coridor10_init:
    ...
    $ add_object_to_scene("Teleport_UtilityRoom", {"type":3, "text" : t_("КАБИНЕТ ЗАВХОЗА"), "rarrow" : "arrow_right_2", "base":"COLLEGE_Coridor_10_Teleport_UtilityRoom", "click" : "college_coridor10_environment", "xpos" : 1600, "ypos" : 1002, "zorder":11, "teleport":True, "group":"teleports"}, scene="college_coridor10")
    return
