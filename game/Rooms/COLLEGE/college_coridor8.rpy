...
label college_coridor8_init:
    ...
    $ add_object_to_scene("Student18", {"type" : 2, "base" : "COLLEGE_Coridor_8_Student18_[collegeStudent18_Suffix]", "click" : "college_coridor8_environment", "actions" : "l", "zorder":10, "selectable": False}, scene="college_coridor8")
