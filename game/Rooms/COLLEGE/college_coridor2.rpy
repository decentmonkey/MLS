...
#    $ add_object_to_scene("Monica", {"type" : 2, "base" : "basement_bedroom1_Monica_[basementBedroom1MonicaSuffix]", "click" : "college_coridor2_environment", "actions" : "l", "zorder":10}, scene="college_coridor2")
    ...
    $ add_object_to_scene("Teleport_Stairs", {"type":3, "text" : t_("ЛЕСТНИЦА"), "larrow" : "arrow_down_2", "base":"Screen_Down_Arrow", "click" : "college_coridor2_environment", "xpos" : 960, "ypos" : 956, "zorder":11, "teleport":True, "group":"teleports"}, scene="college_coridor2")
    $ add_object_to_scene("Teleport_Coridor4", {"type":3, "text" : t_("ГАРДЕРОБ"), "rarrow" : "arrow_right_2", "base":"COLLEGE_Coridor_2_Teleport_Coridor4", "click" : "college_coridor2_environment", "xpos" : 1607, "ypos" : 365, "zorder":11, "teleport":True, "group":"teleports"}, scene="college_coridor2")
    ...
    $ add_object_to_scene("Teleport_Chemistry", {"type":3, "text" : t_("ХИМИЯ"), "rarrow" : "arrow_down_2", "base":"COLLEGE_Coridor_2_Teleport_Chemistry", "click" : "college_coridor2_environment", "xpos" : 1402, "ypos" : 211, "zorder":11, "teleport":True, "group":"teleports"}, scene="college_coridor2")
    return
