...
label college_coridor2_init:
    ...
    $ add_object_to_scene("Student4", {"type" : 2, "base" : "COLLEGE_Coridor_2_Student4_[collegeStudent4_Suffix]", "click" : "college_coridor2_environment", "actions" : "l", "zorder":10, "selectable": False}, scene="college_coridor2")
    $ add_object_to_scene("Student5", {"type" : 2, "base" : "COLLEGE_Coridor_2_Student5_[collegeStudent5_Suffix]", "click" : "college_coridor2_environment", "actions" : "l", "zorder":10, "selectable": False}, scene="college_coridor2")
    $ add_object_to_scene("Student6", {"type" : 2, "base" : "COLLEGE_Coridor_2_Student6_[collegeStudent6_Suffix]", "click" : "college_coridor2_environment", "actions" : "l", "zorder":10, "selectable": False}, scene="college_coridor2")
